...
type System__User__GetLikeUserResponseData_main_findManyuser_user_role struct {
	Main_findManyrole_user []System__User__GetLikeUserResponseData_main_findManyuser_user_role_main_findManyrole_user `json:"main_findManyrole_user"`
}
type System__User__GetLikeUserResponseData_main_findManyuser_user_role_main_findManyrole_user struct {
	Role    System__User__GetLikeUserResponseData_main_findManyuser_user_role_main_findManyrole_user_role `json:"role"`
	Role_id int64                                                                                         `json:"role_id"`
}
type System__User__GetLikeUserResponseData_main_findManyuser_user_role_main_findManyrole_user_role struct {
	Main_findManyrole []System__User__GetLikeUserResponseData_main_findManyuser_user_role_main_findManyrole_user_role_main_findManyrole `json:"main_findManyrole"`
}
type System__User__GetLikeUserResponseData_main_findManyuser_user_role_main_findManyrole_user_role_main_findManyrole struct {
	Code   string `json:"code"`
	Id     int64  `json:"id"`
	Remark string `json:"remark"`
}
